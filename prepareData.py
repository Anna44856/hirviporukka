...
'''
# Temporary object to get hel pabout object properties
resultObject = pgModule.DatabaseOperation()
testConnectionArgs = resultObject.readDatabaseSettingsFromFile('settings.data')
...
def prepareTable(resultObject, tableWidget):
    ...
    Args:
        resultObject (DatabaseOperation): Instance of DatabaseOperation class -> errors and
    ...
    if resultObject.errorCode == 0:
        ...
        for tupleIx in resultObject.resultSet: # Cycle through list of tupples
